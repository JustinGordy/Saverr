      ...
      -->
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form action="/redirects/registerRedirect.php" id="contactForm" method="post">
                    ...
                    <!-- Email input -->
                    <div class="form-outline mb-4">
                      <input type="password" name="pword" class="form-control" placeholder="Verify Password *" required />
                      <label class="form-label" for="pword">Verify Password</label>
                    </div>
